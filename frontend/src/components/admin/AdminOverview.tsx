      ...
      <section className="bg-gradient-to-br from-cyan-500 via-blue-600 via-purple-700 to-pink-600 text-primary-foreground py-12">
        <div className="container">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            ...
            <Card className="rounded-2xl p-0 shadow-2xl bg-white border-2 border-purple-200"><CardHeader className="pb-2"><CardTitle className="text-sm font-bold text-purple-700">Total Revenue</CardTitle></CardHeader><CardContent><div className="text-xl font-black bg-gradient-to-r from-purple-700 to-pink-700 bg-clip-text text-transparent break-all leading-tight" title={`₹${stats?.totalRevenue?.toLocaleString() ?? "0"}`}>₹{stats?.totalRevenue?.toLocaleString() ?? "0"}</div></CardContent></Card>
