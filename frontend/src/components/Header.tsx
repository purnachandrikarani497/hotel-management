...
const Header = () => {
  ...
  const isDashboard = pathname.startsWith("/dashboard/admin") || pathname.startsWith("/dashboard/owner");
  const logoLink = isDashboard ? "#" : "/";
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-gradient-to-r from-blue-50 via-purple-100 via-cyan-100 to-pink-100 border-purple-200 shadow-2xl backdrop-blur-xl relative overflow-hidden">
      ...
      <div className="container flex h-16 items-center justify-between relative z-10">
        <Link to={logoLink} onClick={(e) => isDashboard && e.preventDefault()} className="flex items-center space-x-2 hover:scale-110 transition-transform duration-500 group animate-heartbeat">
